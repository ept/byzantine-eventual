...
To evaluate the algorithms introduced in \S~\ref{sec:algorithm} we implemented a prototype and measured its behavior.\footnote{Source code available at \url{https://github.com/ept/byzantine-eventual}}
