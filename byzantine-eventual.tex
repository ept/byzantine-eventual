...
Then the algorithm defined in Section TODO ensures BEC and preserves all invariants, as proved in Appendix~\ref{sec:proof}, demonstrating the existence of an algorithm.
...
Even in the TPC-C benchmark, most of the transactions and invariants are \I-confluent~\cite{Bailis:2014}.
...
For example, an auction could aggregate bids in an \I-confluent manner, and only requires consensus to decide the winning bid.
