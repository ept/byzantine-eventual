...
\begin{abstract}
    ...
    We introduce algorithms which implement this consistency model, even in a system with arbitrarily many Byzantine-faulty processes, and prove that it ensures BEC.
...
Truong et al.~\cite{Truong:2012et} present a scheme for authenticating CRDT history, but do not include a reconciliation protocol.
