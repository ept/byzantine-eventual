...
% connection is introduced later
% We also allow a sequence of messages exchanged between two processes to be grouped together as a \emph{connection}; like with TCP, a connection may fail (time out) due to message loss, and a new connection may later be reestablished.
...
% DAGs of hashes also appear in:
% Hashgraph https://www.swirlds.com/downloads/SWIRLDS-TR-2016-01.pdf
% Secure Scuttlebutt https://conferences.sigcomm.org/acm-icn/2019/proceedings/icn19-19.pdf
