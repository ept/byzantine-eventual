...
We begin by reviewing how Conflict-free Replicated Data Types (CRDTs) are used to implement Strong Eventual Consistency (SEC) in the non-Byzantine system model.

\subsection{Strong Eventual Consistency \& CRDTs}
